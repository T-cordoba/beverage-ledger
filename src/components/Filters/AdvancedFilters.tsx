      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
        ...
        <div className="relative z-[114]">
          ...
          >
            ...
            <svg
              className={`w-4 h-4 transition-transform duration-200 ${isBrandDropdownOpen ? 'rotate-180' : ''}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="relative z-[113]">
          ...
          >
            ...
            <svg
              className={`w-4 h-4 transition-transform duration-200 ${isOriginDropdownOpen ? 'rotate-180' : ''}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="relative z-[112]">
          ...
          >
            ...
            <svg
              className={`w-4 h-4 transition-transform duration-200 ${isSubcategoryDropdownOpen ? 'rotate-180' : ''}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="relative z-[111]">
          ...
          >
            ...
            <svg
              className={`w-4 h-4 transition-transform duration-200 ${isAgeDropdownOpen ? 'rotate-180' : ''}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="relative z-[110]">
          ...
          >
            ...
            <svg
              className={`w-4 h-4 transition-transform duration-200 ${isAbvDropdownOpen ? 'rotate-180' : ''}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
